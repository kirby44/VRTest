...
public class WebRequest : MonoBehaviour
{
    ...
    //private readonly string uri = "https://ng2iivy4k5.execute-api.us-east-1.amazonaws.com/prod"; //chat
    //private readonly string uri = "https://c637oleo3a.execute-api.us-east-1.amazonaws.com/prod"; //whisper
    private readonly string uri = "https://eibaz2r6zl.execute-api.us-east-1.amazonaws.com/prod"; //openai
    ...
    {
        string response = await OpenAIAsync();
        Debug.Log(response);
    ...
    private async Task<string> OpenAIAsync()
    {
        ...
        string json = "{\"body\":{\"audio_base64\":\"" + base64Audio + "\"}}";
        ...
        using (UnityWebRequest request = new UnityWebRequest(uri, UnityWebRequest.kHttpVerbPOST))
        {
            ...
            //Debug.Log("Response from proxy: " + jObject);
